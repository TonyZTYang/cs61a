...
def announce_highest(who, last_score=0, running_high=0):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    def on_who(score0, score1):
        if who == 0:
            my_score = score0
        else:
            my_score = score1
        if my_score - last_score > running_high:
            print(my_score - last_score, \
                "point(s)! That's the biggest gain yet for Player", who)
            return announce_highest(who, my_score, my_score - last_score)
        else:
            return announce_highest(who, my_score, running_high)
    return on_who
    # END PROBLEM 7
...
def swap_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    if abs((score + 10 - opponent_score % 10 + opponent_score // 10) % 10\
        ...
        if opponent_score > score + 10 - opponent_score % 10 + \
            opponent_score // 10:
            return 0
        else:
            return num_rolls
